...
- **双模式支持** - 河图网关模式 / 直连 Gemini API 模式一键切换
- **机器码绑定** - 自动生成设备唯一标识，支持 API Key 授权绑定
- **功能分级** - 网关模式解锁「分析网络」「快照」等高级功能
...
| 区域 | 功能 |
|------|------|
| **顶部工具栏** | 项目/画布切换、搜索、自动布局、快照、分析网络、生成简报 |
...
1. 打开右侧「设置」面板
2. 在「API 模式」中选择：
   - **河图网关** - 使用河图 API Key，解锁高级功能
   - **直连 Gemini** - 使用 Google Gemini API Key
3. 输入对应的 API Key 并保存
4. 刷新页面使配置生效
